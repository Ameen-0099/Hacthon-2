...
const contact = () => {
    return(
         <div className="h-[1900px] md:h-[1500px]  lg:h-[1050px]">
                   <div className="content ">
                      ...
                      <p className="capitalize p-2 lg:p-0 mt-5 text-[#9f9f9f] flex flex-col lg:flex-row justify-center">for more information about us product & sevice please feel free to drop us</p>
                     <p className="capitalize p-2 lg:p-0 flex flex-col lg:flex-row text-[#9f9f9f] justify-center">an email.our staff always be there to help you out. do not hesitate! </p>
                   </div>
                         {/* add first */}
  ...
  <input placeholder="Abc"className="sm:ml-32 lg:ml-[270px] mt-1 rounded-md outline-none p-4 border border-gray-300  w-72 sm:w-96 md:w-[500px] lg:w-[528.75px]" />
 ...
 <div className="address p-2 lg:p-0 lg:ml-[125px] mt-20 ">
  ...
  <input placeholder="Abc@def.com "className="sm:ml-32 md:w-[500px] lg:ml-[273px] mt-1 rounded-md outline-none p-4 border border-gray-300  w-72 sm:w-96 lg:w-[528.75px]" />
  ...
  <input placeholder="This is an Optional"className="sm:ml-32  lg:ml-16 mt-1 rounded-md outline-none p-4 border border-gray-300 w-72 sm:w-96 md:w-[500px] lg:w-[528.75px]" />
     ...
     <div className="message p-2 lg:p-0  lg:ml-[400px] mt-10">
           <h1 className=" sm:ml-32  md:ml-[200px] lg:ml-0">Message</h1> 
                <input placeholder="Hi I'd like to ask about" className="sm:ml-32 md:ml-[200px] lg:ml-0 border p-5 rounded-md border-gray-300 outline-none w-72 md:w-[500px] sm:w-96 lg:w-[527px] h-[120px]"/>
      
     </div>
    <div className="btn p-5 lg:p-0 sm:ml-28  md:ml-[190px]  lg:ml-[400px] mt-5">
    <button className="w-[227px] h-[56px] bg-[#029fae] rounded-md text-white">Submit</button>
    </div>
     ...
     <div className="high w-full  mt-10 md:ml-0 lg:h-[220px]  bg-[#f4f4f4]">
                 <div className="content flex flex-col md:flex-row lg:flex-row p-10 md:gap-5 justify-around ">
                    <Image src="/frame 5.png" alt="" width={280} height={70}  
                     className="mt-6 "
                    />
                     <Image src="/frame 19.png" alt="" width={280} height={70}  
                     className="mt-6"
                    />
                     <Image src="/frame 4.png" alt="" width={280} height={70}  
                     className="mt-6"
                    />
