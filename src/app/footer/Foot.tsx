...
const Foot = () => {
      return(
           <div>
            <div className="flex flex-col  lg:flex-row  mt-[800px] lg:mt-32  justify-around  h-[343px]   lg:h-[343px] border-t-2 border-gray-200 ">
                          <div className="content">
                                     <div className="img flex lg:mt-20 ml-5 mt-5" >
                                        <Image src="/Logo Icon.png" alt="" width={10} height={10} 
                                         className="w-10 h-10"
                                        />
                          ...
                          <div className="input flex mt-2">
                               <input placeholder="Your email" className="w-[220px] outline-none border rounded-md pl-3 border-gray-300"></input>
                                 <button className="rounded-md ml-2 w-[80px] lg:w-[127px] h-[46px] bg-[#029fae] text-white">Subscribe</button>         
                                 </div>
                         ...
                         <div className="develop mt-[600px]   md:mt-[150px] lg:mt-[0px]  flex flex-col lg:flex-row h-[110px] items-center border-t-2 border-gray-200 ">
                            <p className=" lg:ml-20">@ 2021-Blogy-Designed & Develop by Zakirsoft</p>
                            <Image src="/visa.png" alt="" width={30} height={30}  className=" lg:ml-[650px]"/>
