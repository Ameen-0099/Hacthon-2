...
const allproduct = () => {
  return (
    <div>
      <div className="img ml-0 lg:ml-20 mt-44   sm:mt-10 lg:mt-10  w-[1140px]  lg:w-[1140px]  h-full ">
        ...
        <div className="product ">
            ...
            <div className="img flex-col ">
              ...
              <div className="img flex-col mt-20 lg:mt-10">
                ...
                <div className="content relative">
                  ...
                  <p className="font-bold"> </p>
                  <div className="cart flex absolute ml-32 sm:ml-32 md:ml-14 lg:ml-0 top-2 left-56 bg-[#f0f2f3] rounded-md">
                    <Image
                      src="/Buy 2.png"
                      alt=""
                      height={44}
          ...
          <div className="followproduct  mt-[100px]  sm:mt-[100px] lg:mt-[100px] md:mt-[100px]  h-[2950px]  sm:h-[1350px]  md:h-[1500px] lg:h-auto ">
            <div className="products lg:p-0    gray-100 h-[2870px] lg:h-auto flex-wrap w-[450px]  lg:min-w-full ">
              <div className="content flex  lg:justify-center lg:ml-0">
                <h1 className="lg:text-4xl  text-3xl font-semibold mt-14 ">
              ...
              <div className="input  p-3 flex items-center lg:p-0">
                ...
                ></input>
                <button className="w-[91px] h-[22px] mt-12 underline ml-5">
                  SUBMIT
                </button>
              </div>
              ...
              <div className="img  sm:ml-5 lg:ml-0 md:w-[700px] lg:w-auto    w-[600px]  lg:gap-10 grid sm:grid-cols-2  lg:grid-cols-6 gap-5  mt-10 ">
                <div className="img1">
                  <Image
                    src="/Image (1).png"
                    alt=""
                    width={150}
                    height={150}
                    className="w-[400px] lg:w-[150px]  lg:ml-8 sm:w-[350px]"
                  />
                </div>
                <div className="img2 ">
                  <Image
                    ...
                    width={150}
                    height={150}
                    className="w-[400px] lg:w-[150px]   lg:ml-4  sm:w-[350px]"
                  />
                </div>
                ...
                <div className="img3">
                  <Image
                    ...
                    width={150}
                    height={150}
                    className="w-[400px] lg:w-[150px] sm:w-[350px] "
                  />
                </div>
                <div className="img4">
                  <Image
